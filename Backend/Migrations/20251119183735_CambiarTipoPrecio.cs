...
{
    /// <inheritdoc />
    public partial class CambiarTipoPrecio : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, new DateTime(2025, 10, 20, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5459), 0, 21, 1, 120000 },
                    { 2, false, new DateTime(2025, 10, 21, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5480), 1, 21, 2, 180000 },
                    { 3, false, new DateTime(2025, 10, 22, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5482), 3, 21, 3, 1200 },
                    { 4, false, new DateTime(2025, 10, 23, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5483), 0, 21, 4, 800 },
                    { 5, false, new DateTime(2025, 10, 24, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5485), 2, 21, 5, 1500 },
                    { 6, false, new DateTime(2025, 10, 25, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5487), 3, 21, 6, 3500 },
                    { 7, false, new DateTime(2025, 10, 26, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5488), 0, 21, 7, 9000 },
                    { 8, false, new DateTime(2025, 10, 27, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5491), 1, 21, 8, 2500 },
                    { 9, false, new DateTime(2025, 10, 28, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5493), 2, 21, 9, 5000 },
                    { 10, false, new DateTime(2025, 10, 29, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5494), 0, 21, 10, 7000 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, false, new DateTime(2025, 10, 30, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5529), 0, 21m, 120000m },
                    { 2, 2, false, new DateTime(2025, 10, 31, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5535), 1, 21m, 180000m },
                    { 3, 3, false, new DateTime(2025, 11, 1, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5537), 3, 21m, 1200m },
                    { 4, 4, false, new DateTime(2025, 11, 2, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5539), 0, 21m, 800m },
                    { 5, 5, false, new DateTime(2025, 11, 3, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5542), 2, 21m, 1500m },
                    { 6, 6, false, new DateTime(2025, 11, 4, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5544), 3, 21m, 3500m },
                    { 7, 7, false, new DateTime(2025, 11, 5, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5546), 0, 21m, 9000m },
                    { 8, 8, false, new DateTime(2025, 11, 6, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5548), 1, 21m, 2500m },
                    { 9, 9, false, new DateTime(2025, 11, 7, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5551), 2, 21m, 5000m },
                    { 10, 10, false, new DateTime(2025, 11, 8, 15, 37, 33, 918, DateTimeKind.Local).AddTicks(5553), 0, 21m, 7000m }
                });
